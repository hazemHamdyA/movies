...
<template>
  <div flex gap-12 font-base class="overview">
    ...
    <div flex="~ col justify-center" gap-12>
      ...
      <ul grid="~ cols-2" font-500>
        <li>
          <div flex items-center gap-4 mb-5>
            <p>Released</p>
            <p>{{ formaDate(movie.release_date) || "N/A " }}</p>
          </div>
        </li>
        <li>
          <div flex items-center gap-4 mb-5>
            <p>Runtime</p>
            <p>{{ formatTime(movie.runtime) || "N/A " }}</p>
          </div>
        </li>
        <li>
          <div flex items-center gap-4 mb-5>
            <p>Directo</p>
            <NuxtLink to="/">{{
              directorName(movie.credits) || "N/A "
            }}</NuxtLink>
          </div>
        </li>
        <li>
          <div flex items-center gap-4 mb-5>
            <p>Budget</p>
            <p>{{ formatCurrency(movie.budget) || "N/A " }}</p>
          </div>
        </li>
        <li>
          <div flex items-center gap-4 mb-5>
            <p>Revenue</p>
            <p>{{ formatCurrency(movie.revenue) || "N/A " }}</p>
          </div>
        </li>
        <li>
          <div flex items-center gap-4 mb-5>
        ...
        <li>
          <div flex="~ items-center" gap-4>
            <p>Production</p>
            <p class="w-[400px]">
              {{ getCompanies(movie.production_companies) || "N/A " }}
            </p>
          </div>
        </li>
        <li>
          <div flex items-center gap-4 mb-5>
            <p>Language</p>
            <p>
              {{ languagesShortcuts[movie.original_language] || "N/A " }}
            </p>
          </div>
        </li>
      </ul>
